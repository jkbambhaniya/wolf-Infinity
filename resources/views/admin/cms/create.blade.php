...
<div class="card mb-5 mb-xl-10">
	...
	<form method="POST" action="{{ route('admin.cms.store') }}" enctype="multipart/form-data"
		class="form fv-plugins-bootstrap5 fv-plugins-framework" id="cms_create_form">
		@csrf
		<!--begin::Card body-->
			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					<input type="text" name="name"
						...
						placeholder="name" value="{{ old('name') }}" maxlength="70">
					@error('name')
			...
			<div class="row mb-6">
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					<textarea id="description" name="description"
						class="tox-target @error('description') is-invalid @enderror"></textarea>
					@error('description')
					<span class="invalid-feedback" role="alert">
						{{ $message }}
					</span>
		...
		<div class="card-footer d-flex justify-content-end py-6 px-9">
			<button type="submit" class="btn btn-primary" id="cms_create_submit">Save</button>
		</div>
		<!--end::Actions-->
	</form>
</div>
...
<script src="{{ asset('admin-assets/js/admin/cms/create.js') }}?{{ time() }}"></script>
@endsection