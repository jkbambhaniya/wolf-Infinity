...
<div class="card mb-5 mb-xl-10">
	...
	<!--begin::Card header-->
	<form method="POST" action="{{ route('admin.user.update',$user->hashId) }}" enctype="multipart/form-data"
		class="form fv-plugins-bootstrap5 fv-plugins-framework" id="user_edit_form">
		@method('PUT')
		@csrf
		<!--begin::Card body-->
					...
					<div class="row">
						...
						<div class="col-lg-6 fv-row fv-plugins-icon-container">
							<input type="text" name="last_name"
								...
								placeholder="Last name" value="{{ old('last_name',$user->last_name) }}" maxlength="35">
							@error('last_name')
							<span class="invalid-feedback" role="alert">
								{{ $message }}
							</span>
				...
				<div class="col-lg-8 fv-row fv-plugins-icon-container">
					...
					<div class="input-group">
						...
						<input type="text" name="date_of_birth" id="date_of_birth"
							...
							placeholder="Date Of Birth" maxlength="35"
							value="{{old('date_of_birth',\Carbon\Carbon::parse($user->date_of_birth)->format(config('app.date_format')))}}"><i
							data-field="date_of_birth" class="fv-plugins-icon"></i>
		...
		<div class="card-footer d-flex justify-content-end py-6 px-9">
			<button type="submit" class="btn btn-primary" id="user_edit_submit">Save Changes</button>
		</div>
		<!--end::Actions-->
	</form>
</div>
...
<script>
	...
	const phoneValue = "{{old('phone', $user->phone)}}";
...
<script src="{{ asset('admin-assets/js/admin/user/edit.js') }}?{{ time() }}"></script>
@endsection